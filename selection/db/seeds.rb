...
User.create(
  email: "edesanna@hotmail.com", provider: "google_oauth2", uid: "123", full_name: "Édes Anna", access_token: nil, 
  admin: false
  )
...
User.create(
  email: "KKriszti@hotmail.com", provider: "google_oauth2", uid: "124", full_name: "Kiss Krisztina", access_token: nil, 
  admin: false
  )
...
User.create(
  email: "erosp@freemail.com", provider: "google_oauth2", uid: "125", full_name: "Erős Pista", access_token: nil, 
  admin: false
  )
