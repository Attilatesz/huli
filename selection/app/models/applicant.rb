class Applicant < ApplicationRecord
  ...
  validates_length_of :first_name, :last_name, allow_blank: true, minimum: 3, maximum: 35,
  too_short: 'Minimum 3 characters'

  validates_length_of :phone_number, allow_blank: true, in: 10..15,
  too_short: 'Minimum 3 characters'

  validates_presence_of :english_class, :payment_option,
  message: 'Please choose one of the options'

  validates_format_of :first_name, :last_name, allow_blank: true, with: /\A[a-zA-Z]+\z/,
  message: 'Only letters allowed'

  validates_numericality_of :phone_number, allow_blank: true, only_integer: true,
